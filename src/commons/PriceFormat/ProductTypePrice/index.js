...
const SimpleProductTypePrice = ({
        ...
        return (
            <>
                <Typography
                    ...
                    className={cx('price-text', '!font-bold', 'text-[20px]', 'text-neutral-800', 'price-case-8', textClassName)}
                >
                    {formatPrice(finalPrice.value + otherPrice, finalPrice.currency, currencyCache)}
                </Typography>
                <Typography variant={priceLabelSubVariant} className={cx('price-text invisible', textClassName)}>
                    <strike>{formatPrice(finalPrice.value + otherPrice, finalPrice.currency, currencyCache)}</strike>
                </Typography>
            </>
        );
    }
    ...
    return (
        <div className={cx('price-case-9 price-text-discount', 'inline-flex', 'flex-col')}>
            {/* case 9 */}
            <Typography variant={priceLabelVariant} className={cx('price-text', '!font-bold', 'text-[20px]', 'text-neutral-800', textClassName)}>
                {validSpecial
                    ? formatPrice(finalPrice.value + otherPrice, finalPrice.currency, currencyCache)
