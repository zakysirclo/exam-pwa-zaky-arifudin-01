...
const WelcomeMessage = dynamic(() => import('@core_modules/theme/components/welcome'), { ssr: true });
    ...
    return (
        <>
            ...
            <div className={pageNameSelector}>
                ...
                {withLayoutFooter && (
                    <footer
                        className={cx(`${footerVersion}`, '!block', 'mt-[50px]', font.variable, 'font-sans', '!font-pwa-default')}
                        ref={refFooter}
                    >
            ...
            {showRecentlyBar && !onlyCms && (
                ...
                <ScrollToTop deviceType={deviceType} showGlobalPromo={showGlobalPromo} {...props} className={!hasWebpSupport ? 'bottom-10' : ''} />
                {!hasWebpSupport ? (
