            ...
            <div className="magezon-slider group flex flex-col relative">
                {owl_nav ? (
                    ...
                    >
                        <div
                            className={cx(
                                'magezon-slider--button-nav-item-1',
                                'cursor-pointer',
                                'pointer-events-auto',
                                'text-[1.5rem]',
                                'bg-base-black',
                        ...
                        >
                            <ChevronLeft className="w-6 h-6 text-base-white hover:text-primary" />
                        </div>
                        <div
                            className={cx(
                                'magezon-slider--button-nav-item-2',
                                'cursor-pointer',
                                'pointer-events-auto',
                                'text-[1.5rem]',
                                'bg-base-black',
                        ...
                        >
                            <ChevronRight className="w-6 h-6 text-base-white hover:text-primary" />
                        </div>
                    </div>
                ) : null}
