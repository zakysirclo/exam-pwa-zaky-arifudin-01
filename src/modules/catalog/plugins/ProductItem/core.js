...
const ProductItem = (props) => {
    ...
    const generatePrice = (priceDataItem = []) => {
        ...
        return (
            <div className="product-item-price flex flex-col">
            ...
            <div className="flex flex-col gap-2 tablet:gap-4 text-center">
                ...
                <div className="hidden tablet:flex desktop:flex flex-row gap-1 justify-center items-center w-full">
                    <Show when={showAddToCart && !viewItemOnly}>
                        <Button
                            ...
                            className={classNames(
                                'swift-action-tocart !py-[8px] !px-[16px] w-max h-[auto] tablet:max-w-[116px] desktop:max-w-max justify-center',
                                'hover:shadow-[0_0_0_4px] hover:shadow-primary-300',
                            )}
                        >
                            <Typography color="white" className="font-normal text-base tablet:truncate">
                    ...
                    <Show when={showAddToCart && viewItemOnly}>
                        ...
                        >
                            <Typography color="white" className="font-normal text-base">
